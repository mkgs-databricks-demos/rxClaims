...
This folder defines all source code for the 'ncpdp_segments_etl' pipeline:
...
* Take a look at the sample under "sample_users_ncpdp_segments_etl.py" to get familiar with the syntax.
