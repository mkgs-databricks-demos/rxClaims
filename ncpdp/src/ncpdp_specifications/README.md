# ncpdp_specifications

This folder defines all source code for the 'ncpdp_specifications' pipeline:
...
* Take a look at the sample under "sample_users_ncpdp_specifications.py" to get familiar with the syntax.
